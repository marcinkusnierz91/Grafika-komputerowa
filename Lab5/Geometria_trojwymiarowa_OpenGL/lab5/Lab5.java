...
public class Lab5 extends GLJPanel implements GLEventListener, KeyListener{
	...
	private void corkscrew(GL2 gl2) {
	    int n = 5;
	    gl2.glColor3f(2, 8, 3);
	    gl2.glLineWidth(2.0f);  // Set the line width to 2.0

	    gl2.glBegin(GL2.GL_LINE_STRIP);  // Begin drawing a line strip
	    ...
	    for (int i = 0; i < (15 * n); i++) {
	        ...
	        gl2.glVertex3f(x, y, z);  // Add the vertex to the line strip
	    }

	    gl2.glEnd();  // End drawing the line strip
	}
